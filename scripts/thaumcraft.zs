...
Crucible.addRecipe("GT_INFUSED_POTIONS", <ThaumicTinkerer:infusedSeeds>.withTag({mainAspect: {Aspects: [{amount: 1, key: "aer"}]}}), <InfinityCore:itemMaterial:17>, "aer 8");
Crucible.addRecipe("GT_INFUSED_POTIONS", <ThaumicTinkerer:infusedSeeds>.withTag({mainAspect: {Aspects: [{amount: 1, key: "ignis"}]}}), <InfinityCore:itemMaterial:17>, "ignis 8");
Crucible.addRecipe("GT_INFUSED_POTIONS", <ThaumicTinkerer:infusedSeeds>.withTag({mainAspect: {Aspects: [{amount: 1, key: "aqua"}]}}), <InfinityCore:itemMaterial:17>, "aqua 8");
Crucible.addRecipe("GT_INFUSED_POTIONS", <ThaumicTinkerer:infusedSeeds>.withTag({mainAspect: {Aspects: [{amount: 1, key: "terra"}]}}), <InfinityCore:itemMaterial:17>, "terra 8");
Crucible.addRecipe("GT_INFUSED_POTIONS", <ThaumicTinkerer:infusedSeeds>.withTag({mainAspect: {Aspects: [{amount: 1, key: "ordo"}]}}), <InfinityCore:itemMaterial:17>, "ordo 8");
Crucible.addRecipe("GT_INFUSED_POTIONS", <ThaumicTinkerer:infusedSeeds>.withTag({mainAspect: {Aspects: [{amount: 1, key: "perditio"}]}}), <InfinityCore:itemMaterial:17>, "perditio 8");
