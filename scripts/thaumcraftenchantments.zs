...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTEFFICIENCY.1", "Analysis of the various tools specialized for mining has led you to the proper infusion process for applying the \u00A79Efficiency\u00A70 enchantment.");
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTUNBREAKING.1", "Analysis of the various materials that tend to resist erosion has led you to the proper infusion process for applying the \u00A79Unbreaking\u00A70 enchantment.");
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTFIREPROTECTION.1", "Analysis of the various materials with intrinsic anti-flame properties has led you to the proper infusion process for applying the \u00A79Fire Protection\u00A70 enchantment.");
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTBLASTPROTECTION.1", "Analysis of the various materials with intrinsic explosive and anti-explosive properties has led you to the proper infusion process for applying the \u00A79Blast Protection\u00A70 enchantment.");
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTPROJECTILEPROTECTION.1", "Analysis of the various materials with intrinsic anti-piercing properties has led you to the proper infusion process for applying the \u00A79Projectile Protection\u00A70 enchantment.");
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTFEATHERFALLING.1", "You realized that the Protection enchantment does not actually mitigate fall damage - this has led you to develop a way of separately applying the \u00A79Feather Falling\u00A70 enchantment.");
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTSMITE.1", "Analysis of the various metals with intrinsic anti-undead properties has led you to the proper infusion process for applying the \u00A79Smite\u00A70 enchantment.");
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTBANEOFARTHROPODS.1", "Analysis of the various metals with intrinsic anti-spider properties has led you to the proper infusion process for applying the \u00A79Bane of Arthropods\u00A70 enchantment.");
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTDISJUNCTION.1", "Analysis of the various metals with intrinsic anti-teleportation properties has led you to the proper infusion process for applying the \u00A79Disjunction\u00A70 enchantment.");
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTSHARPNESS.1", "Analysis of the various metals with intrinsic affinity for weaponcraft has led you to the proper infusion process for applying the \u00A79Sharpness\u00A70 enchantment.");
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTPOWER.1", "The same process used for the Sharpness enchantment may, with slight modifications, be applied to bows as well - the \u00A79Power\u00A70 enchantment.");
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTKNOCKBACK.1", "Analysis of the various tools capable of knocking foes back has led you to the proper infusion process for applying the \u00A79Knockback\u00A70 enchantment.");
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTPUNCH.1", "The same process used for the Knockback enchantment may, with slight modifications, be applied to bows as well - the \u00A79Punch\u00A70 enchantment.");
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTFIREASPECT.1", "The beautiful dancing flames of the nether has led you to an epiphany - you now understand how to imbue mundane tomes with the \u00A79Fire Aspect\u00A70 enchantment.<BR>Now, they shall all burn.");
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTFLAME.1", "The same process used for the Fire Aspect enchantment may, with slight modifications, be applied to bows as well - the \u00A79Flame\u00A70 enchantment.");
...
game.setLocalization("en_US", "tc.research_name.GT_ENCHANTMENTHASTE", "Enchantment - Haste");
game.setLocalization("en_US", "tc.research_text.GT_ENCHANTMENTHASTE", "Gotta go fast");
Research.addPage("GT_ENCHANTMENTHASTE", "kirara.research_page.GT_ENCHANTMENTHASTE.1");
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTHASTE.1", "Sometimes, even sprinting may not get you to where you want quickly enough.<BR>Thaumaturgically augmenting your equipment with the \u00A79Haste\u00A70 enchantment may fix that.");
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTREPAIR.1", "The Unbreaking enchantment may make a tool exceedingly durable, but it will still break eventually.<BR>However, when the item is properly imbued with arcane magic, it becomes possible to restore any damage done to the item by slowly infusing it with vis.<BR>This enchantment slowly repairs the durability of items by drawing vis from the aura. The higher the level of the enchantment, the quicker this takes place. This enchantment can only be applied to items made with Thaumcraft, and even then not all of them.");
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTRIDEPROTECT.1", "Moving around is incredibly difficult when someone is piggyback-riding you. Enchanting your helmet with the \u00A79Throwoff\u00A70 enchantment should fix that problem. Everyone who tries to jump upon you will get thrown off and damaged.");
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTSTEALTH.1", "More often than not, sneaking is not an option due to the high senses of the creatures you face. Well now it is! Applying the \u00A79Stealth\u00A70 enchantment to your boots or leggings will give you a chance of staying undetected while you are crouching. The chance rises by 10% with every level, but is diminished by 10% if you are in view of the target in question.<BR>Should you be discovered, all enemies in a 5 block radius will be notified.");
...
Research.addInfusionPage("GT_ENCHANTMENTSTEALTH", <minecraft:enchanted_book>);
Infusion.removeRecipe(<minecraft:enchanted_book>);
Infusion.addRecipe("GT_ENCHANTMENTSTEALTH", <minecraft:book>, [salisMundus, <bluepower:sapphire_glass>], "auram 12, praecantatio 12, motus 12, tenebrae 12", <minecraft:enchanted_book>.withTag({StoredEnchantments:[{id:68,lvl:4}]}), 6);
Research.addInfusionPage("GT_ENCHANTMENTSTEALTH", <minecraft:enchanted_book>);
Infusion.removeRecipe(<minecraft:enchanted_book>);
...
game.setLocalization("en_US", "kirara.research_page.GT_ENCHANTMENTBACKSTAB.1", "With your newfound ability to sneak, comes a new option of combat. By attacking enemies from behind you use the element of surpise to avoid the enemy's defenses. Items enchanted with \u00A79Backstab\u00A70 do additional 20% damage per level when attacking from behind, plus another 40% when the target is not aware of you.");
