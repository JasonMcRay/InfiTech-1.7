...
game.setLocalization("en_US", "tc.research_text.PURECOBALT", "[GT] Purification of cobaltite into native clusters");
...
game.setLocalization("en_US", "tc.research_text.PUREZINC", "[GT] Purification of sphalerite into native clusters");
...
game.setLocalization("en_US", "tc.research_text.PUREMOLYBDENUM", "[GT] Purification of molybdenite into native clusters");
