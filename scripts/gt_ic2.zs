...
var aureli		= <IC2:itemCropSeed>.onlyWithTag({name: "aurelia", scan: 4 as byte});
...
//eatingplant		.addTooltip("Source of ");
...
//plumbiscus		.addTooltip("Source of ");
