...
var cypriu		= <IC2:itemCropSeed>.onlyWithTag({name: "cyprium", scan: 4 as byte});
...
//stagnium		.addTooltip("Source of "); //probably tin
...
eatingplant		.addTooltip(format.red(format.bold("DANGER plant likes to eat mobs and players")));
...
plumbiscus		.addTooltip(format.red(format.bold("only grows with a Block of Lead underneath")));
...
cyprium 		.addTooltip(format.red(format.bold("only grows with a Block of Copper underneath")));
...
trollplant 		.addTooltip(format.red(format.bold("looks like fully grown Aurelia, Tearstalk, Diareed, Enderbloom")));
...
godOfThunder 		.addTooltip(format.red(format.bold("only grows with a Block of Thorium underneath")));
steeleafranks		.addTooltip("Source of stealeaf + stealeaf dust");
pyrolusium		.addTooltip("Source of pyrolusium leaf");
pyrolusium 		.addTooltip(format.red(format.bold("only grows with a Block of Manganese underneath")));
creeperweed		.addTooltip("Source of gunpowder");
titania 		.addTooltip("Source of titania leaf");
titania 		.addTooltip(format.red(format.bold("only grows with a Block of Titanium underneath")));
